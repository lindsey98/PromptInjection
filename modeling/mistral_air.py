...
import inspect
from .mistral_ise import _resolve_expert_labels

logger = logging.get_logger(__name__)


class MistralAIRConfig(MistralConfig):
...
class MistralModel(transformers.MistralModel):
    def __init__(self, config: MistralAIRConfig):
...
class MistralForCausalLMAIR(transformers.MistralForCausalLM):
