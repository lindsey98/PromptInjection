...
plt.rcParams.update({
    ...
    "font.size": 20, "axes.titlesize": 20,
    "axes.labelsize": 20, "xtick.labelsize": 18, "ytick.labelsize": 20,
...
#     "Ours + Fakecompletion",
#     "Ours + ThinkIntervene",
#     "Ours + SpotlightDelimit",
#     "Ours + SpotlightDatamark",
#     "Ours + SpotlightEncode",
# ]

# --- Example data (replace with your actual numbers) ---
# # Format: group -> (SEP Score %, Utility %)
# data_points = {
#     "Ours": (80.9, 83.9),
#     "Ours + Reminder": (82.1, 78.5),
#     "Ours + Sandwitch": (79.0, 62.1),
#     "Ours + Fakecompletion": (77.6, 55.9),
#     "Ours + ThinkIntervene": (80.7, 75.6),
#     "Ours + SpotlightDelimit": (81.4, 69.8),
#     "Ours + SpotlightDatamark": (79.0, 67.0),
#     "Ours + SpotlightEncode": (85.2, 64.2),
# }
#
# # --- Plot ---
# fig, ax = plt.subplots(figsize=(12, 8), dpi=150)
#
# # Use distinct markers (no explicit colors)
# markers = ["o", "s", "^", "D", "P", "X", "8", "v"]
#
# for i, g in enumerate(groups):
#     x, y = data_points.get(g, (None, None))
...
#
# # Axes formatting
# ax.set_xlabel("SEP Score (%)", fontweight="bold")
...
#
# # Show percent formatting on ticks
...
#
# # Diagonal reference (y=x) to compare SEP vs Utility alignment
