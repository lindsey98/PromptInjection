...
def format_prompt(elem: Dict, template: Dict, mode: str = 'data_with_probe', defense: str="none") -> Tuple[str, str]:
...
if __name__ == "__main__":
    ...
    for i, data_point in enumerate(tqdm(dataset, desc=f"Processing dataset")):
        ...
        instruction_with_prob = format_prompt(data_point, PROMPT_FORMAT[frontend_delimiters],
