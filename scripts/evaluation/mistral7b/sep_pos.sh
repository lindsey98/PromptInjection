...
task0() { CUDA_VISIBLE_DEVICES=$DEV0 python -m testing.sep.test_sep $COMMON_ARGS --base_model_path mistralai/Mistral-7B-Instruct-v0.3 --attack stress_repeat_6; }
task1() { CUDA_VISIBLE_DEVICES=$DEV1 python -m testing.sep.test_sep $COMMON_ARGS --base_model_path mistralai/Mistral-7B-Instruct-v0.3 --attack stress_repeat_12; }
