...
CMD="CUDA_VISIBLE_DEVICES=$CUDA_ID python -m testing.test_gcg --attack attngcg --base_model_path mistralai/Mistral-7B-Instruct-v0.3 --model_name_or_path $MODEL_PATH $EXTRA_FLAGS"
