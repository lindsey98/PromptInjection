...
class BaseAttack:
    ...
    def run(self, messages: list[Message], target: str) -> AttackResult:
        ...
        eval_input = self._suffix_manager.gen_eval_inputs(
            ...
            user_seperator=self.delm_ids[0],
        ...
        for i in range(self._num_steps):
            ...
            eval_input.expert_labels = expert_labels
            ...
            if (i+1) % self._log_freq == 0 or i == 0:
                ...
                self.log(
                    log_dict={
                        ...
                        "success_exact_response": result[2] == 1,
                        "suffix": adv_suffix,
                        "generated": result[3][0][0],  # last message
                    },
                )
